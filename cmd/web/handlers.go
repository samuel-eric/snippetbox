...
import (
	...
	"github.com/samuel-eric/snippetbox/internal/models"
	"github.com/samuel-eric/snippetbox/internal/validator"
)
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	redirectUrl := app.sessionManager.GetString(r.Context(), "redirectPathAfterLogin")
	if redirectUrl == "" {
...
func (app *application) about(w http.ResponseWriter, r *http.Request) {
	app.render(w, r, http.StatusOK, "about.tmpl.html", app.newTemplateData(r))
}
